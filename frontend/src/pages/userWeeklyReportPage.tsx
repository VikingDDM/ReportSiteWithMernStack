...
const UserWeeklyReportPage = () => {
    ...
    const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - userWeeklyReports[0]?.length) : 0;
        ...
        <Container>
           ...
           <TableContainer component={Paper} style={{marginTop:"30px"}} >
                <Table className='borderTable' sx={{ Width: 500 }} aria-label="custom pagination table" >
                  ...
                  <TableBody>
                    {(rowsPerPage > 0
                      ? userWeeklyReports[0]?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                      : userWeeklyReports[0]
                    )?.map((row:any, key: any) => (
